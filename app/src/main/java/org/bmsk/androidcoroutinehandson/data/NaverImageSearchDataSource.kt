...
class NaverImageSearchDataSource(
    private val query: String, private val imageSearchService: NaverImageSearchService
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Item> {
        ...
        return try {
            val response = imageSearchService.getImages(
                query = query, display = params.loadSize, start = start
            )
